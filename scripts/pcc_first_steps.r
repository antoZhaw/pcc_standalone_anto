...
aoi_shp <- as.character(paste(cfg$area_of_interest, sep = ""))
...
las_cliff <- filter_poi(las, Classification == LASRAIL)
# plot(las_cliff, size = 1, color = "RGB", bg = "black")
