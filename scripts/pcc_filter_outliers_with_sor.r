...
# Read data ####
# Leaving filter argument empty discards essential information such as RGB.
las <- readLAS(path_input_data)

# Classify outliers as noise with SOR
...
# Create a new filtered las and a separated las with outliers
